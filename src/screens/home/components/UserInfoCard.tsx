  ...
  return (
    <View style={styles.cardWrapper}>
      ...
      <View style={styles.cardContainer}>
        <LinearGradient
          colors={['#f5f5f5', '#e8e8e8', colors.primary[100], colors.primary[300], colors.primary[500]]}
        ...
        >
          ...
          <LinearGradient
            colors={['rgba(255,255,255,0.4)', 'rgba(255,255,255,0.2)', 'rgba(255,255,255,0.1)', 'transparent']}
          ...
          {/* Orta ışıltı efekti */}
          <LinearGradient
            colors={['transparent', 'rgba(255,255,255,0.3)', 'rgba(255,255,255,0.2)', 'transparent']}
...
const styles = StyleSheet.create({
  ...
  userName: {
    ...
    letterSpacing: Platform.OS === 'ios' ? 0.1 : 0.3,
  },
  euroContainer: {
    position: 'absolute',
    bottom: 48,
